...
struct NewsModel: HandyJSON {
    ...
    var content = ""
    var attributedContent: NSMutableAttributedString { return emojiManager.emojiShow(content: content, font: UIFont.systemFont(ofSize: 17)) }
...
struct SmallVideo: HandyJSON {
    ...
    var attrbutedText: NSMutableAttributedString {
        return emojiManager.emojiShow(content: title, font: UIFont.systemFont(ofSize: 17))
    }
